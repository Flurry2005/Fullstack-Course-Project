...
function SellerDashBoard() {
  ...
  const [toggleStatViews, setToggleStatViews] = useState(false);
  ...
  return (
    <div className="bg-[#f9f5ff]">
      ...
      <div className="relative">
        {/* Dashboard header */}
        <main
        onClick={() => setToggleStatViews(false)}
          className={`${toggleStatViews ? "opacity-50" : ""} flex flex-col gap-10 bg-[#f9f5ff] mx-auto p-6 w-full container`}
        >
          <section
          ...
          <section className="gap-6 grid grid-cols-1 md:grid-cols-4">
            <div className="flex flex-col h-fit bg-white p-6 border-[#ACA8D7]/15 border-2 rounded-2xl w-full">
            ...
            <div className="flex flex-col h-fit bg-white p-6 border-[#ACA8D7]/15 border-2 rounded-2xl w-full">
              ...
              <span className="flex items-center gap-1 font-semibold text-3xl">
                ...
                <ChartLine
                  onClick={(e) => { e.stopPropagation(), setToggleStatViews((prev) => !prev)}}
                  className={`${toggleStatViews ? "opacity-50" : ""}  text-blue-600 cursor-pointer w-5 ml-auto hover:opacity-50 h-5`}
                />
              </span>
            </div>
          </section>
          ...
          <div className="gap-12 grid grid-cols-1 md:grid-cols-[2fr_1fr]">
            ...
            <section className="flex flex-col gap-6 bg-[#ACA8D7]/10 p-6 border-[#ACA8D7]/15 border-2 rounded-2xl h-fit">
              <div className="flex">
                <h2 className="text-[#060607] text-2xl align-middle">
                  Messages
                </h2>
      ...
      {toggleStatViews && (
        ...
        >
          ...
          <div className="flex flex-col h-120 gap-6 bg-white shadow-md p-6 border border-[#ACA8D7]/15 rounded-2xl">
            {" "}          
            <Statistics gigs={Array.isArray(gigs) ? gigs : []} subject="Views" />
          </div>
        </div>
      )}

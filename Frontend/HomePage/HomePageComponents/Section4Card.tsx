...
function Section4Card({ title, icon, text }: CraftCardProps) {
  return (
    <div className="flex flex-col justify-center items-center bg-white shadow-[0_0_0_1px_rgba(35,35,91,0.04)] hover:shadow-md p-5 rounded-[22px] w-1/6 h-full text-center transition hover:-translate-y-1">

...
function NavBar() {
  ...
  return (
    <header className="z-50 relative flex flex-wrap justify-between items-center shadow-lg/4 px-6 w-full md:h-fit min-h-17">
      {/* Left side */}
      <Logo />
      {/* Middle side */}
        ...
        {user ? (
          <div>
            <Link
              ...
              type="button"
              className="flex justify-center items-center bg-indigo-500 shadow-[0_0_20px_rgba(122,162,255,0.35)] border rounded-full w-9 h-9 font-bold text-white text-sm hover:scale-105 transition"

      ...
      <div className="flex flex-col gap-6 w-[50vw]">
        <div className="flex flex-col gap-6 shadow-md border border-[#C7C4D8] bg-white p-6 rounded-2xl">
          ...
          <div className="flex gap-6">
            <div className="flex relative flex-col items-center justify-center border-dashed h-100 border-2 rounded-lg w-2/3 border-[#C7C4D8]">
              {primaryImagePreview && (
                <img
                  src={removeImageicon}
            ...
            <div className="flex gap-6 flex-col h-100  w-1/3">
              ...
              >
                ...
                <img
                  src={
                    ternaryImagePreview ? ternaryImagePreview : defaultImageIcon
                  }
        ...
        <div className="flex flex-col gap-6 border-2 text-[#3525CD] border-[#C7C4D8]/10 bg-[#C3C0FF]/10 p-6 rounded-2xl">
          <div className="flex flex-col gap-6">
            ...
            <ul className=" flex flex-col gap-1 px-9">
              ...
              <ul>
                <li>
                  - Images must not contain offensive symbols, harassment, or
                  abusive material.
                </li>
              </ul>
              <li>
      ...
      <div className="flex flex-col gap-6 w-[20vw]">
        ...
        <div className="flex flex-col shadow-md bg-white rounded-2xl border-[#C7C4D8] border">
          <div className="relative">
            <img
              src={primaryImagePreview ? primaryImagePreview : defaultImageIcon}

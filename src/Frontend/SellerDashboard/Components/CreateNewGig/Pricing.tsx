...
function Pricing({
  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <div className="gap-6 grid grid-cols-1 md:grid-cols-3 md:mx-auto md:w-[75vw]">
        <Package
          newGig={newGig}
          tier="basic"
          setBasic={setBasic}
      ...
      <div className="flex flex-col place-self-center gap-3 md:col-span-3 bg-[#006E4B] p-6 rounded-2xl md:w-[50vw] text-[#67F4B7]">

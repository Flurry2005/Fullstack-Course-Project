...
function CheckoutPage() {
  return (
    <>
      ...
      {/* Main container */}
      <main className="flex justify-between items-start gap-5 bg-[#f9f5ff] px-5 h-screen">
        {/* Left main container */}
        <div className="flex flex-col gap-5 w-7/10">
          ...
          <section className="flex gap-5 w-full">
            <button className="flex flex-col bg-[#ffff] p-5 rounded-2xl w-1/3 h-30">
            ...
            <button className="flex flex-col bg-[#ffff] p-5 rounded-2xl w-1/3 h-30">
              <i className="text-2xl fa-brands fa-paypal"></i>
              <h3 className="text-left">PayPal</h3>
              <h4 className="text-left">Direct wallet transfer</h4>
            </button>

            <button className="flex flex-col bg-[#ffff] p-5 rounded-2xl w-1/3 h-30">
              <i className="text-4xl fa-brands fa-apple-pay"></i>
